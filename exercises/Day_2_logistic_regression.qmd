...
- In are the apparent associations more compatible with a harmful or protective effect of these exposures?
...
begining with a univaribal logistic regression model including only "dneo", sequentially add "dclox" and "dcpct. 
