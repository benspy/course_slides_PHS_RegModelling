...
$$\mathcal{L}(\pi|y=9)=P_{n=12,\pi}(Y=9)=\binom{12}{9} \pi^9(1-\pi)^{3}$$
...
![ ](pics/oncho_area_mf.png){fig-align="center"}
...
On the odds scale: 
![ ](pics/oncho_dich_odds.png){fig-align="center"}


On the log odds scale: 
![ ](pics/oncho_dich_logodds.png){fig-align="center"}
...
... we see that the proportion of persons in the oldest(youngest) age category is higher(lower) in rainforest areas compared to savannah areas.

This suggests that the observed univariable associations might be confounded. 

## Model with two variables
To adjuts for the potential confounding let's include both variables
