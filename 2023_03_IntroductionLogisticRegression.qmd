...
* Present case:  $\hat{\beta_0}=$ estimated  log odds for age 0 years (no practical meaning)
* $x$ is a centered continuous variable: $\hat{\beta_0}=$ estimated log odds when $x$ is set to the sample mean
* $x$ is a dichotomous variable (0,1 coding): $\hat{\beta_0}=$ estimated log odds for reference category (baseline log odds)
